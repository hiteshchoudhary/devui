    ...
    <div className="h-screen overflow-y-auto bg-[#121212] text-white">
      ...
      <div className="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
        ...
        <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
          <div className="relative w-full pt-[16.28%]">
          ...
          <div className="px-4 pb-4">
            <div className="flex -translate-y-6 flex-wrap justify-between gap-4 md:flex-nowrap">
              <div className="inline-flex gap-4">
                <span className="inline-block h-28 w-28 overflow-hidden rounded-full border-2">
                  <img
                ...
                <div className="first-letter inline-block pt-11">
              ...
              <div className="inline-block pt-11">
                <button className="group/btn mr-1 flex w-full items-center gap-x-2 bg-[#ae7aff] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] sm:w-auto">
                  ...
                  <span className="hidden group-focus/btn:block">Unfollow</span>
                </button>
              </div>
            </div>
            <ul className="sticky top-[66px] z-40 flex flex-row gap-x-2 border-b border-gray-600 bg-[#121212] py-2 sm:top-[82px]">
              <li className="w-full">
              ...
              <li className="w-full">
                <button className="w-full px-3 py-1.5 text-gray-400">
                  Playlist
                </button>
              </li>
              <li className="w-full">
