    ...
    <div className="h-screen overflow-y-auto bg-[#121212] text-white">
      <header className="sticky inset-x-0 top-0 z-50 w-full border-b border-white bg-[#121212] px-4">
        <nav className="mx-auto flex max-w-7xl items-center py-2">
          <div className="mr-4 w-16 shrink-0">
            <svg
              style={{ width: "100%" }}
              viewBox="0 0 63 64"
              fill="none"
          ...
          <div className="ml-4 shrink-0 sm:hidden">
            <button className="group flex w-6 flex-wrap gap-y-1.5">
          ...
          <div className="ml-4 hidden shrink-0 items-center gap-x-4 sm:flex">
            <button className="h-7 w-7 cursor-pointer rounded-full p-1 duration-500 active:bg-[#4f4e4e] active:duration-0">
              <EllipsisVerticalIcon className="w-full" />
            </button>
            <button className="px-3 py-2 hover:bg-[#4f4e4e]">Log in</button>
            <button className="mr-1 bg-[#ae7aff] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e]">
              Sign up
            </button>
          </div>
        </nav>
